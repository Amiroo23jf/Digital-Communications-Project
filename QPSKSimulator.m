function [bit_err, theoretic_err, output_audio] = QPSKSimulator(bit_seq, phase, coding, Eb, N0)
...
% QPSK Modulation
bits_modulated = QPSKModulation(bits_encoded, Eb);

% Channel
bits_received = Channel(bits_modulated, N0, phase);

% QPSK Demodulation
bits_demodulated = QPSKDemodulation(bits_received, isequal(mod(length(bits_encoded), 2), 1));
